(function (global, factory) {
  ...
  */
  ...
  var propTypes_7 = propTypes.checkPropTypes;
  var propTypes_8 = propTypes.shape;
  ...
  var keyboardKey_2 = keyboardKey_1.getKey;
  ...
  function getPropTypesValidator(caller, propTypes) {
    ...
    return function (options) {
      ...
      Object.entries(propTypes).forEach(function (_ref2) {
        var key = _ref2[0];
        propTypes_7(propTypes, options, key, caller.name);
      });
    };
  }
  ...
  var propTypes$1 = {
    items: propTypes_6.isRequired,
    itemToString: propTypes_1,
    getA11yStatusMessage: propTypes_1,
    getA11ySelectionMessage: propTypes_1,
    circularNavigation: propTypes_4,
    highlightedIndex: propTypes_5,
    defaultHighlightedIndex: propTypes_5,
    initialHighlightedIndex: propTypes_5,
    isOpen: propTypes_4,
    defaultIsOpen: propTypes_4,
    initialIsOpen: propTypes_4,
    selectedItem: propTypes_3,
    initialSelectedItem: propTypes_3,
    defaultSelectedItem: propTypes_3,
    id: propTypes_2,
    labelId: propTypes_2,
    menuId: propTypes_2,
    getItemId: propTypes_1,
    toggleButtonId: propTypes_2,
    stateReducer: propTypes_1,
    onSelectedItemChange: propTypes_1,
    onHighlightedIndexChange: propTypes_1,
    onStateChange: propTypes_1,
    onIsOpenChange: propTypes_1,
    environment: propTypes_8({
      addEventListener: propTypes_1,
      removeEventListener: propTypes_1,
      document: propTypes_8({
        getElementById: propTypes_1,
        activeElement: propTypes_3,
        body: propTypes_3
      })
    })
  };
  ...
  function useSelect(userProps) {
    ...
    var _useReducer = React.useReducer(function (state, action) {
      ...
      var reducedState = stateReducer(state, _extends({}, action, {
        changes: changes
