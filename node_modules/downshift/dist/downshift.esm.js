...
import PropTypes__default, { checkPropTypes, array, func, bool, number, any, string, shape } from 'prop-types';
...
process.env.NODE_ENV !== "production" ? Downshift.propTypes = {
  ...
  initialHighlightedIndex: PropTypes__default.number,
  initialSelectedItem: PropTypes__default.any,
  initialInputValue: PropTypes__default.string,
  initialIsOpen: PropTypes__default.bool,
  ...
  suppressRefError: PropTypes__default.bool,
  scrollIntoView: PropTypes__default.func,
  ...
  menuId: PropTypes__default.string,
  getItemId: PropTypes__default.func
...
function getPropTypesValidator(caller, propTypes) {
  ...
  return function (options) {
    ...
    Object.entries(propTypes).forEach(function (_ref2) {
      var key = _ref2[0];
      checkPropTypes(propTypes, options, key, caller.name);
    });
  };
}
